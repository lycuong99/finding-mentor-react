import { Collapse, Icon, List, ListItem, ListItemText, Typography } from "@mui/material";
...
export default function NavCollapse({ item, level }) {
    ...
    return (
        <React.Fragment><ListItem button
            sx={{ borderRadius: 4 }}
            key={item.title} className={level > 1 ? classes.listItemNoBack : classes.listItem} onClick={handleClick}
